 ...
 * 2012-03-13T16:10:53.326+02:00
 * Generated source version: 2.5.2
 * 
 */
@WebService(targetNamespace = "urn:epcglobal:epcis:wsdl:1", name = "EPCISServicePortType")
@XmlSeeAlso({org.ow2.aspirerfid.commons.epcis.model.ObjectFactory.class, org.ow2.aspirerfid.commons.epcglobal.commons.ObjectFactory.class})
...
public interface EPCISServicePortType {
    ...
    @WebMethod
    public org.ow2.aspirerfid.commons.epcis.model.ArrayOfString getQueryNames(
        @WebParam(partName = "parms", name = "GetQueryNames", targetNamespace = "urn:epcglobal:epcis-query:xsd:1")
        org.ow2.aspirerfid.commons.epcis.model.EmptyParms parms
    ...
    @WebMethod
    public org.ow2.aspirerfid.commons.epcis.model.VoidHolder unsubscribe(
        @WebParam(partName = "parms", name = "Unsubscribe", targetNamespace = "urn:epcglobal:epcis-query:xsd:1")
        org.ow2.aspirerfid.commons.epcis.model.Unsubscribe parms
    ) throws NoSuchSubscriptionExceptionResponse, ImplementationExceptionResponse, SecurityExceptionResponse, ValidationExceptionResponse;

    @WebResult(name = "QueryResults", targetNamespace = "urn:epcglobal:epcis-query:xsd:1", partName = "pollReturn")
    @WebMethod
    public org.ow2.aspirerfid.commons.epcis.model.QueryResults poll(
        @WebParam(partName = "parms", name = "Poll", targetNamespace = "urn:epcglobal:epcis-query:xsd:1")
        org.ow2.aspirerfid.commons.epcis.model.Poll parms
    ) throws QueryTooLargeExceptionResponse, ImplementationExceptionResponse, NoSuchNameExceptionResponse, QueryTooComplexExceptionResponse, SecurityExceptionResponse, ValidationExceptionResponse, QueryParameterExceptionResponse;

    @WebResult(name = "SubscribeResult", targetNamespace = "urn:epcglobal:epcis-query:xsd:1", partName = "subscribeReturn")
    @WebMethod
    public org.ow2.aspirerfid.commons.epcis.model.VoidHolder subscribe(
        @WebParam(partName = "parms", name = "Subscribe", targetNamespace = "urn:epcglobal:epcis-query:xsd:1")
        org.ow2.aspirerfid.commons.epcis.model.Subscribe parms
    ) throws ImplementationExceptionResponse, NoSuchNameExceptionResponse, SubscriptionControlsExceptionResponse, QueryTooComplexExceptionResponse, SubscribeNotPermittedExceptionResponse, DuplicateSubscriptionExceptionResponse, SecurityExceptionResponse, ValidationExceptionResponse, InvalidURIExceptionResponse, QueryParameterExceptionResponse;
    ...
    @WebMethod
    public org.ow2.aspirerfid.commons.epcis.model.ArrayOfString getSubscriptionIDs(
        @WebParam(partName = "parms", name = "GetSubscriptionIDs", targetNamespace = "urn:epcglobal:epcis-query:xsd:1")
        org.ow2.aspirerfid.commons.epcis.model.GetSubscriptionIDs parms
