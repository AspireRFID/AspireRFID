...
public class CLCBProcItemProvider
	...
	/**
	 * This adds a property descriptor for the Biz Location File feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBizLocationFilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CLCBProc_bizLocationFile_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CLCBProc_bizLocationFile_feature", "_UI_CLCBProc_type"),
				 BpwmePackage.Literals.CLCB_PROC__BIZ_LOCATION_FILE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
