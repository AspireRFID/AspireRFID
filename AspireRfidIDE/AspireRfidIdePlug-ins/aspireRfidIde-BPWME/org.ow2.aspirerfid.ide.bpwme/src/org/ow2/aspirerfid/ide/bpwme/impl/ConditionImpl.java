...
public class ConditionImpl extends EObjectImpl implements Condition {
	...
	protected EClass eStaticClass() {
		return BpwmePackage.Literals.CONDITION;
	}
	...
	public EList<Object> getContent() {
		if (content == null) {
			content = new EDataTypeUniqueEList<Object>(Object.class, this, BpwmePackage.CONDITION__CONTENT);
		}
		return content;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BpwmePackage.CONDITION__TYPE, oldType, type));
	}
