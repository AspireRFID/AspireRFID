...
public class PeUnregisterProcessActionProvider extends CommonActionProvider {

	private PeUnregisterProcessAction peUnregisterProcessAction;

	public PeUnregisterProcessActionProvider() {
	...
	public void init(ICommonActionExtensionSite site) {
		...
		if (viewSite instanceof ICommonViewerWorkbenchSite) {
			...
			peUnregisterProcessAction = new PeUnregisterProcessAction(workbenchSite.getPage(), workbenchSite
	...
	public void fillActionBars(IActionBars actionBars) {
		if (peUnregisterProcessAction.isEnabled()) {
			actionBars.setGlobalActionHandler(ICommonActionConstants.OPEN, peUnregisterProcessAction);
		}
	}
	...
	public void fillContextMenu(IMenuManager menu) {
		if (peUnregisterProcessAction.isEnabled()) {
			menu.appendToGroup(ICommonMenuConstants.GROUP_OPEN, peUnregisterProcessAction);
		}
	}
	 ...
	 * Open Action
	 */
	class PeUnregisterProcessAction extends Action {
		...
		public PeUnregisterProcessAction(IWorkbenchPage workbenchPage, ISelectionProvider selectionProvider) {
			super("Unregister");
