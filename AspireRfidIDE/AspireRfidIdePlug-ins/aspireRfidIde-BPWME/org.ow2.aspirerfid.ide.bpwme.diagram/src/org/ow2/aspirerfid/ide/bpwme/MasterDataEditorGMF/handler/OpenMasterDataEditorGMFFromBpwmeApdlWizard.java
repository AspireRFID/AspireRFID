...
import org.ow2.aspirerfid.ide.MasterDataEditorGMF.diagram.part.MasterDataEditorGMFDiagramEditorUtil;
 ...
 *
 */
public class OpenMasterDataEditorGMFFromBpwmeApdlWizard extends Wizard implements
		INewWizard {
	...
	public void addPages() {		
		...
		for (int i = 0; i < diagramModelFilePage.length; i++) {
			...
			URI uri = fileURI.trimFileExtension();
	...
	public boolean performFinish() {
		...
		MasterDataEditorGMFDiagramEditorUtil.apdlBpwmeClcbCount = 0;
		
		for (int i = 0; i < diagram.length; i++) {
			MasterDataEditorGMFDiagramEditorUtil.apdlBpwmeClcbCount = i;
			createDiagrams(i);
		}
	...
	public boolean createDiagrams(final int count) {
		...
		IRunnableWithProgress op = new IRunnableWithProgress() {
			...
			public void run(IProgressMonitor monitor)
				...
				MasterDataGMFCreateFromFile.setFromBpwmeApdl(true);
