 ...
 * @generated
 */
public class BpwmeDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.BpwmeDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS
									.bind(
											Messages.BpwmeDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = BpwmeDiagramEditorPlugin
	...
	*/
	 ...
	 * @generated
	 */
	private static WorkflowMap createInitialModel() {
		return BpwmeFactory.eINSTANCE.createWorkflowMap();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(WorkflowMap model,
			Resource resource) {
