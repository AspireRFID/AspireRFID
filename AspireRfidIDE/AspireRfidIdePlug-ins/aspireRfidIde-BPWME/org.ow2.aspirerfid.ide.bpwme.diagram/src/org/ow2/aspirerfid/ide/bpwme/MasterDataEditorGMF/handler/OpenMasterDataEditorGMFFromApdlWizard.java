...
public class OpenMasterDataEditorGMFFromApdlWizard extends Wizard implements
	...
	public void addPages() {		
		...
		for (int i = 0; i < diagramModelFilePage.length; i++) {
			...
			String defaultPath = home + File.separator + MasterDataGMFCreateFromFile.getClcProcNames().get(i) + File.separator;
	...
	public boolean performFinish() {
		...
		MasterDataEditorGMFDiagramEditorUtil.apdlClcbCount = 0;
		
		for (int i = 0; i < diagram.length; i++) {
			MasterDataEditorGMFDiagramEditorUtil.apdlClcbCount = i;
			createDiagrams(i);
		}
