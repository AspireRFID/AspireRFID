 ...
 *
 */
public class ImportMasterDataEditorGMFWizardPage extends WizardPage {
	 ...
	 * @return the radioNew
	 */
	public Button getRadioNew() {
		return radioNew;
	}

	/**
	 * @return the radioExisting
	 */
	public Button getRadioExisting() {
		return radioExisting;
	}
	 ...
	 * Constructor
	 */
	public ImportMasterDataEditorGMFWizardPage(String name, IStructuredSelection currentSelection) {
		super(name);
	...
	public void createControl(Composite parent) {
		...
		radioNew = new Button(plate, SWT.RADIO);
		radioNew.setSelection(true);
		radioNew.setText("Create new MasterDataEditorGMF Diagram");
		radioNew.setLayoutData(new GridData(SWT.BEGINNING, SWT.CENTER, false, false, 2, 1));
		
		radioExisting = new Button(plate, SWT.RADIO);
		radioExisting.setText("Use existing MasterDataEditorGMF Diagram");
		radioExisting.setLayoutData(new GridData(SWT.BEGINNING, SWT.CENTER, false, false, 2, 1));
		...
		final Button button = new Button(plate, SWT.PUSH);
		...
		radioNew.addSelectionListener(new SelectionListener() {
		...
		radioExisting.addSelectionListener(new SelectionListener() {

			public void widgetSelected(SelectionEvent e) {
				filePathEditor.setEditable(true);
