 ...
 * @generated
 */
public class CLCBProcItemSemanticEditPolicy extends
		BpwmeBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CLCBProcItemSemanticEditPolicy() {
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (BpwmeVisualIDRegistry.getVisualID(node)) {
			case CLCBProcCLCBCompartmentEditPart.VISUAL_ID:
				for (Iterator cit = node.getChildren().iterator(); cit
						.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (BpwmeVisualIDRegistry.getVisualID(cnode)) {
