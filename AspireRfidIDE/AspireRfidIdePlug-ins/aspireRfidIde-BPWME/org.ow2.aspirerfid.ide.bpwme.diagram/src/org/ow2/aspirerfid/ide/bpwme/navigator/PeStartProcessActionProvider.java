...
public class PeStartProcessActionProvider extends CommonActionProvider {

	private PeStartProcessAction peStartProcessAction;

	public PeStartProcessActionProvider() {
	...
	public void init(ICommonActionExtensionSite site) {
		...
		if (viewSite instanceof ICommonViewerWorkbenchSite) {
			...
			peStartProcessAction = new PeStartProcessAction(workbenchSite.getPage(), workbenchSite
	...
	public void fillActionBars(IActionBars actionBars) {
		if (peStartProcessAction.isEnabled()) {
			actionBars.setGlobalActionHandler(ICommonActionConstants.OPEN, peStartProcessAction);
		}
	}
	...
	public void fillContextMenu(IMenuManager menu) {
		if (peStartProcessAction.isEnabled()) {
			menu.appendToGroup(ICommonMenuConstants.GROUP_OPEN, peStartProcessAction);
		}
	}
	 ...
	 * Open Action
	 */
	class PeStartProcessAction extends Action {
		...
		public PeStartProcessAction(IWorkbenchPage workbenchPage, ISelectionProvider selectionProvider) {
			super("Start");
