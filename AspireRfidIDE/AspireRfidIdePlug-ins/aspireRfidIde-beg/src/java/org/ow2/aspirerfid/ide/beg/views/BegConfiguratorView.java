...
public class BegConfiguratorView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		if (PreferenceConstants.begConfiguration==null){
			PreferenceConstants.begConfiguration = new BegConfiguration();
		}
	...
	private void fillStartedBusinessEventsCombo() {
		...
		ArrayList<String> startedBusinessEvents = PreferenceConstants.begConfiguration.getStartedEvents();
	...
	private void fillAvailableBusinessEventsCombo() {
		...
		try {
			vocabularyElementList = PreferenceConstants.begConfiguration.getEventList(preferences.getString(PreferenceConstants.P_EpcisRepositoryQueryURL));
...
//	}
	...
	private class StartCaptureButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			...
			boolean saccesful = PreferenceConstants.begConfiguration.startBegForEvent(recievedVocabularyElementList.get(vocabularyElementSelected), preferences
	...
	private class StopCaptureButtonMouseListener extends MouseAdapter {
		public void mouseDown(final MouseEvent e) {
			...
			PreferenceConstants.begConfiguration.stopBegForEven(startedBusinessEventsCombo.getText());
			fillStartedBusinessEventsCombo();
