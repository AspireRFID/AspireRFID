 ...
 *
 */
public class ReadPointProperties extends PropertySource {
	
	/**
	 * ReadPoint
	 */
	private AbstractContainer element = (AbstractContainerImpl) getElement();
	 ...
	 * Constructor
	 */
	public ReadPointProperties(Object object) {
		super(object);
	}
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {		
		...
		for (int i = 0; i < MasterDataEditParts.getNewReadPointAttr().length; i++) {
			if (!(MasterDataEditParts.getNewReadPointAttr()[i].isEmpty() && MasterDataEditParts.getNewReadPointAttr()[i] == "")) {
				count++;
			}
		}
		...
		for (int i = 4, j = 0; i < propertyDescriptors.length; i++, j++) {
			propertyDescriptors[i] = new TextPropertyDescriptor(MasterDataEditParts.getNewReadPointAttr()[j], 
					MasterDataEditParts.getNewReadPointAttr()[j]);
		}
	...
	public Object getPropertyValue(Object propertyId) {
		...
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[0]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[0]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[1]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[1]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[2]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[2]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[3]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[3]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[4]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[4]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[5]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[5]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[6]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[6]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[7]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[7]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[8]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[8]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[9]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[9]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[10]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[10]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[11]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[11]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[12]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[12]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[13]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[13]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[14]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[14]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[15]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[15]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[16]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[16]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[17]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[17]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[18]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[18]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[19]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[19]);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[20]))
			return getRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[20]);
	...
	public void setPropertyValue(Object propertyId, Object value) {	
		...
		if (propertyId.equals("ID"))
			...
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[0], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[1]))
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[1], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[2])) 
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[2], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[3]))
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[3], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[4])) 
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[4], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[5]))
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[5], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[6])) 
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[6], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[7]))
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[7], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[8])) 
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[8], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[9]))
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[9], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[10])) 
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[10], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[11]))
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[11], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[12])) 
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[12], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[13]))
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[13], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[14])) 
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[14], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[15]))
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[15], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[16])) 
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[16], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[17]))
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[17], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[18])) 
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[18], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[19]))
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[19], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewReadPointAttr()[20])) 
			setRandomPropertyValue(MasterDataEditParts.getNewReadPointAttr()[20], (String) value);
	}
		...
		for (int i = 0; i <  elementAttr.length; i++) {
			...
			if (!(elementAttr[i].isEmpty() && elementAttr[i] == "")) {
				...
				for (int j = 0; j < MasterDataEditParts.getNewReadPointAttr().length; j++) {
					...
					System.out.println(MasterDataEditParts.getNewReadPointAttr()[j]);
					if (elementAttr[i].startsWith(MasterDataEditParts.getNewReadPointAttr()[j] + "_")) {
