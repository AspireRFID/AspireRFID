 ...
 *
 */
public class CompanyProperties extends PropertySource {
	
	/**
	 * Company
	 */
	private Company element = (CompanyImpl) getElement();
	 ...
	 * Constructor
	 */
	public CompanyProperties(Object object) {
		super(object);
	}
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {		
		...
		IPropertyDescriptor[] propertyDescriptors = new PropertyDescriptor[6 + count];
		...
		propertyDescriptors[3] = new TextPropertyDescriptor("Address", "Address");
		propertyDescriptors[4] = new TextPropertyDescriptor("City", "City");
		propertyDescriptors[5] = new TextPropertyDescriptor("Country", "Country");
		
		for (int i = 6, j = 0; i < propertyDescriptors.length; i++, j++) {
			propertyDescriptors[i] = new TextPropertyDescriptor(MasterDataEditParts.getNewCompanyAttr()[j], 
					MasterDataEditParts.getNewCompanyAttr()[j]);
		}
	...
	public Object getPropertyValue(Object propertyId) {
		...
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[0]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[0]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[1]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[1]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[2]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[2]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[3]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[3]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[4]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[4]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[5]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[5]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[6]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[6]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[7]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[7]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[8]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[8]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[9]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[9]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[10]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[10]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[11]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[11]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[12]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[12]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[13]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[13]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[14]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[14]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[15]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[15]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[16]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[16]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[17]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[17]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[18]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[18]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[19]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[19]);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[20]))
			return getRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[20]);
	...
	public void setPropertyValue(Object propertyId, Object value) {	
		...
		if (propertyId.equals("ID"))
			...
			element.setCity((String) value);
		else if (propertyId.equals("Country"))
			element.setCountry((String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[0])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[0], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[1]))
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[1], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[2])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[2], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[3]))
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[3], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[4])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[4], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[5]))
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[5], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[6])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[6], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[7]))
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[7], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[8])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[8], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[9]))
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[9], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[10])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[10], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[11]))
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[11], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[12])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[12], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[13]))
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[13], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[14])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[14], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[15]))
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[15], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[16])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[16], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[17]))
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[17], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[18])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[18], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[19]))
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[19], (String) value);
		else if (propertyId.equals(MasterDataEditParts.getNewCompanyAttr()[20])) 
			setRandomPropertyValue(MasterDataEditParts.getNewCompanyAttr()[20], (String) value);
	}
	...
	private void resetProperties() {
		...
		for (int i = 0; i <  elementAttr.length; i++) {
			...
			if (!(elementAttr[i].isEmpty() && elementAttr[i] == "")) {
				...
				for (int j = 0; j < MasterDataEditParts.getNewCompanyAttr().length; j++) {
					
					System.out.println(MasterDataEditParts.getNewCompanyAttr()[j]);
					if (elementAttr[i].startsWith(MasterDataEditParts.getNewCompanyAttr()[j] + "_")) {
