 ...
 * 
 */
public class BusinessStepReader extends epcisQueryModule
{
	public BusinessStepReader(QueryClientGuiHelper client)
	{
		super(client, "urn:epcglobal:epcis:vtype:BusinessStep");
	}
