 ...
 * 
 */
public class ReadPointsReader extends epcisQueryModule
{
	public ReadPointsReader(QueryClientGuiHelper client)
	{
		super(client, "urn:epcglobal:epcis:vtype:ReadPoint");
	}
}
