 ...
 * 
 */
public class CompanyStringListEditor extends ListEditor {
	 ...
	 */
	protected CompanyStringListEditor() {
	}
	 ...
	 */
	public CompanyStringListEditor(String name, String labelText, String dialogtitle,String inputStringtitle, Composite parent) {
		init(name, labelText);
...
//			path.append(",");
		...
		for (int i = 0; i < MasterDataEditParts.getNewCompanyAttr().length; i++) {
			path.append(MasterDataEditParts.getNewCompanyAttr()[i]);
			path.append(",");
		}
