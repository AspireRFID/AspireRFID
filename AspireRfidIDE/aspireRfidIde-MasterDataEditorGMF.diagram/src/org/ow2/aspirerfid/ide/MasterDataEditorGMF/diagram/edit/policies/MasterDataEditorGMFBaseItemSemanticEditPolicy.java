 ...
 * @generated
 */
public class MasterDataEditorGMFBaseItemSemanticEditPolicy extends
		SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest
					.setParameter(
							org.ow2.aspirerfid.ide.MasterDataEditorGMF.diagram.edit.helpers.MasterDataEditorGMFBaseEditHelper.EDIT_POLICY_COMMAND,
							command);
		}
		if (elementType != null) {
