 ...
 * 
 */
public class WarehouseStringListEditor extends ListEditor {
	 ...
	 */
	protected WarehouseStringListEditor() {
	}
	 ...
	 */
	public WarehouseStringListEditor(String name, String labelText, String dialogtitle,String inputStringtitle, Composite parent) {
		init(name, labelText);
