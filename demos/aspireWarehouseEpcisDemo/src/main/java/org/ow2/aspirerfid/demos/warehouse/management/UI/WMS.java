...
public class WMS {
	...
	public void actionPerformed(final ActionEvent arg0) {
		...
		deliveryInfoModel.addRow(new Object[] {item.getCompany(), item.getItemCode(), item.getDescription(), item.getExpectedQuantity(), item.getMeasurementID()});
	    }
	}
    }
	...
	URL fileurl = this.getClass().getClassLoader().getResource("WarehouseParameters.xml");
	DeliveryItem item;
	Shipment shipment;
	String invoiceId;
	int items;
