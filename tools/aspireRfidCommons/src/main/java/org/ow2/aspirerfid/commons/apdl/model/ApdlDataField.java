 ...
 *           &lt;element ref="{urn:epcglobal:alelr:xsd:1}LRSpec" maxOccurs="unbounded"/>
 *         &lt;/choice>
...
public class ApdlDataField {
     ...
     * This is why there is not a <CODE>set</CODE> method for the lrSpec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLRSpec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<LRSpec> getLRSpec() {
        if (lrSpec == null) {
            lrSpec = new ArrayList<LRSpec>();
        }
        return this.lrSpec;
    }
