...
public class TimeEstimation {
    ...
    @XmlElement(name = "WaitingTime", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected String waitingTime;
    @XmlElement(name = "WorkingTime", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected String workingTime;
    @XmlElement(name = "Duration", namespace = "http://www.wfmc.org/2002/XPDL1.0")
