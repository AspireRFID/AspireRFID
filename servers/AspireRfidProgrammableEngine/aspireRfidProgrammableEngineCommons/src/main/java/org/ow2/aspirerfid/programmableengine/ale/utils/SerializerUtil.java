...
package org.ow2.aspirerfid.programmableengine.ale.utils;
...
import org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr.AddReaders;
import org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr.RemoveReaders;
import org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr.SetProperties;
import org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr.SetReaders;
...
public class SerializerUtil {
	...
	public static void serializeLRSpec(LRSpec spec, String pathName, boolean pretty) throws IOException {
		try {
			String JAXB_CONTEXT = "org.ow2.aspirerfid.programmableengine.ale.wsdl.ale";
			JAXBContext context = JAXBContext.newInstance(JAXB_CONTEXT);
			Marshaller marshaller = context.createMarshaller();
	
			marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, new Boolean(true));

			org.ow2.aspirerfid.programmableengine.model.ObjectFactory objFactory = new org.ow2.aspirerfid.programmableengine.model.ObjectFactory();
	...
	public static void serializeSetProperties(SetProperties props, String pathName) throws IOException {
		try {
			String JAXB_CONTEXT = "org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr";
			JAXBContext context = JAXBContext.newInstance(JAXB_CONTEXT);
			Marshaller marshaller = context.createMarshaller();

			marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, new Boolean(true));
			
			org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr.ObjectFactory objFactory = new org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr.ObjectFactory();
	...
	private static void serializeECSpec(ECSpec ecSpec, FileOutputStream writer, boolean pretty) throws IOException {
		try {
			String JAXB_CONTEXT = "org.ow2.aspirerfid.programmableengine.model";
			JAXBContext context = JAXBContext.newInstance(JAXB_CONTEXT);
			Marshaller marshaller = context.createMarshaller();
