...
public class Package {
    ...
    @XmlElement(name = "PackageHeader", namespace = "http://www.wfmc.org/2002/XPDL1.0", required = true)
    protected PackageHeader packageHeader;
    @XmlElement(name = "RedefinableHeader", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected RedefinableHeader redefinableHeader;
    @XmlElement(name = "ConformanceClass", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected ConformanceClass conformanceClass;
    @XmlElement(name = "Script", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected Script script;
    @XmlElement(name = "ExternalPackages", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected ExternalPackages externalPackages;
    @XmlElement(name = "TypeDeclarations", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected TypeDeclarations typeDeclarations;
    @XmlElement(name = "Participants", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected Participants participants;
    @XmlElement(name = "Applications", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected Applications applications;
    @XmlElement(name = "DataFields", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected DataFields dataFields;
    @XmlElement(name = "WorkflowProcesses", namespace = "http://www.wfmc.org/2002/XPDL1.0")
