...
@XmlType(name = "CLCBProc", namespace = "urn:ow2:aspirerfid:apdlspec:xsd:1", propOrder = {
    "description",
    "ebProc",
    "transitions"
})
public class CLCBProc {
    ...
    @XmlElement(name = "EBProc", namespace = "urn:ow2:aspirerfid:apdlspec:xsd:1", required = true)
