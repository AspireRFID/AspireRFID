...
public class DuplicateNameExceptionResponse extends Exception {
    ...
    private org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr.DuplicateNameException duplicateNameException;
    ...
    public DuplicateNameExceptionResponse(String message, org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr.DuplicateNameException duplicateNameException) {
        super(message);
        this.duplicateNameException = duplicateNameException;
    }

    public DuplicateNameExceptionResponse(String message, org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr.DuplicateNameException duplicateNameException, Throwable cause) {
        super(message, cause);
        this.duplicateNameException = duplicateNameException;
    }

    public org.ow2.aspirerfid.programmableengine.ale.wsdl.alelr.DuplicateNameException getFaultInfo() {
