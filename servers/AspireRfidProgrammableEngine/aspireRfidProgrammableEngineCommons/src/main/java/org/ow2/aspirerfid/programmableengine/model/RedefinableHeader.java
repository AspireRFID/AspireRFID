...
public class RedefinableHeader {
    ...
    @XmlElement(name = "Author", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected String author;
    @XmlElement(name = "Version", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected String version;
    @XmlElement(name = "Codepage", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected String codepage;
    @XmlElement(name = "Countrykey", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected String countrykey;
    @XmlElement(name = "Responsibles", namespace = "http://www.wfmc.org/2002/XPDL1.0")
