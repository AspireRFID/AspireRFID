...
public class Activity {
    ...
    @XmlElement(name = "Route", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected Route route;
    @XmlElement(name = "Implementation", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected Implementation implementation;
    @XmlElement(name = "BlockActivity", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected BlockActivity blockActivity;
    @XmlElement(name = "Performer", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected String performer;
    @XmlElement(name = "StartMode", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected StartMode startMode;
    @XmlElement(name = "FinishMode", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected FinishMode finishMode;
    @XmlElement(name = "Priority", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected String priority;
    @XmlElement(name = "Deadline", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected List<Deadline> deadline;
    @XmlElement(name = "SimulationInformation", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected SimulationInformation simulationInformation;
    @XmlElement(name = "Icon", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected String icon;
    @XmlElement(name = "Documentation", namespace = "http://www.wfmc.org/2002/XPDL1.0")
    protected String documentation;
    @XmlElement(name = "TransitionRestrictions", namespace = "http://www.wfmc.org/2002/XPDL1.0")
