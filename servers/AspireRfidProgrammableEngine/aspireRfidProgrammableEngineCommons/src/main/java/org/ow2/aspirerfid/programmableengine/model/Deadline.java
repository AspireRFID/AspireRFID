...
public class Deadline {
    ...
    @XmlElement(name = "DeadlineCondition", namespace = "http://www.wfmc.org/2002/XPDL1.0", required = true)
    protected Object deadlineCondition;
    @XmlElement(name = "ExceptionName", namespace = "http://www.wfmc.org/2002/XPDL1.0", required = true)
