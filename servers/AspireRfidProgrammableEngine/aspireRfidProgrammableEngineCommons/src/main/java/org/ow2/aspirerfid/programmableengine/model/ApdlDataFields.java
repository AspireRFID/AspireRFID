...
@XmlRootElement(name = "DataFields", namespace = "urn:ow2:aspirerfid:apdlspec:xsd:1")
public class ApdlDataFields {

    @XmlElement(name = "DataField", namespace = "urn:ow2:aspirerfid:apdlspec:xsd:1", required = true)
