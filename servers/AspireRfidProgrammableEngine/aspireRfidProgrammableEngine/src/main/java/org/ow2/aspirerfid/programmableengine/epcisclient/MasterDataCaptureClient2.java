 ...
 * through the capture interface. MasterData will be sent to the module using
 * HTTP POST requests.
 * 
 * @author Nikos Kefalakis(nkef) 
 * 
 */
public class MasterDataCaptureClient2 {
	 ...
	 * The logger.
	 */
	private static Log log = LogFactory.getLog(MasterDataCaptureClient2.class);
     ...
     */
    public MasterDataCaptureClient2() {
        this(null);
    }
     ...
     */
    public MasterDataCaptureClient2(final String url) {
        // load properties
     ...
     *  so if it already exists it will do nothing except if the mode
     *  is set to "2".
     * 
     * @param vocabularyType
     * @param vocabularyURI
