...
/**
 * This class receives new events from the repository and encapsulates them into
 * Event objects. Then forwards them for transmition to the connector client.
 * 
...
public class QueryResultsProcessor extends Thread implements QueryResultsProcessorIfce {
	...
	/**
	 * Parses a given element from the EPCIS repository which is in XML String
	 * format, and encapsulates it in an Event object.
	 * 
	 * @param result
	 ...
	 * 
	 * @see
	 * org.ow2.aspirerfid.commons.connector.interfaces.QueryResultsProcessorIfce
	 * #fetchQueryResult(java.lang.String)
	 */
