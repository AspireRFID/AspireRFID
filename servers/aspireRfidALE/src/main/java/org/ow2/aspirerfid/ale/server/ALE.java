...
import org.ow2.aspirerfid.ale.server.readers.LogicalReaderManager;
import org.ow2.aspirerfid.ale.server.readers.rp.InputGenerator;
...
public class ALE {
	...
	private final static String DEFAULT_PROPERTIES_PATH = "/InputGenerators.properties";
	...
	public static void initialize(String propertiesFilePath) throws ImplementationExceptionResponse {
		...
		System.out.println("Configuration file URI is at:"+ALE.class.getResource("/log4j.properties").toString());
		
		// load properties file
		Properties props = new Properties();
		try {
			props.load(ALE.class.getResourceAsStream(propertiesFilePath));
			System.out.println("Configuration file URI is at:"+ALE.class.getResource(propertiesFilePath).toString());
