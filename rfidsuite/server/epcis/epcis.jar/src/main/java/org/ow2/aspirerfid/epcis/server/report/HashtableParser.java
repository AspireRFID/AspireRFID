 ...
 */
package org.ow2.aspirerfid.epcis.server.report;
...
public class HashtableParser {
    public static Hashtable<String, String> stringToHashtable(String data) {
        ...
        for (int i = 0; i < datas.length; i++) {
            int separator = datas[i].indexOf("=");
            String key = datas[i].substring(0, separator).trim();
            String value = datas[i].substring(separator + 1).trim();
