...
/**
 * Remote interface of the reports aggregator Bean.
 * 
 * @author François Fornaciari
 * @version 2007
 */
public interface ReportsAggregatorRemote {
    /**
     * This method is called when a report is received and filters out
     * duplicated reports.
     * 
     * @param report
     *            The report to save
     ...
     */
    public boolean onReport(Map<String, String> report);
    
    /**
     * Initialize the received reports list
     */
