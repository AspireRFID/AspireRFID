...
/**
 * Local interface of the ONS Updater Bean.
 * 
 * @author François Fornaciari
 * @version 2007
 */
public interface ONSUpdaterLocal {
    /**
     * This method is called periodically. It updates ONS by sending it the new
     * read tags excluding the tags for which it is the owner.
     */
    public void updateONS(Timer timer);
}
