...
/**
 * Edit user widget callback.
 * 
 * @author Guillaume Vaudaux-Ruth
 * @version 2007
 */
public class EditUserCallbackGetListRole implements AsyncCallback {
    private EditUser editUsers;
     ...
     * @param editUsers
     */
    public EditUserCallbackGetListRole(EditUser editUsers) {
    ...
    public void onSuccess(Object result) {
        editUsers.setRoleListBox((List) result);
    }
}
