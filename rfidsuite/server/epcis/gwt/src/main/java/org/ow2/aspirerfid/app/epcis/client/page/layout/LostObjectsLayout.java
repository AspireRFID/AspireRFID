...
import org.ow2.aspirerfid.app.epcis.client.widget.warnings.WarningLost;
 ...
 * @version 2007
 */
public class LostObjectsLayout implements PageLayout {

	private final VerticalPanel vp;
	private final WarningLost wl;

	/**
	 * TODO Javadoc
	 */
	public LostObjectsLayout() {
		// Content
		...
		table.addField(ReportGroupListMemberTable.FIELD_EPC, "EPC");
		table
				.addField(ReportGroupListMemberTable.FIELD_DATE,
						"Last appearance");
		wl = new WarningLost(table);
		Fieldset f = new Fieldset("Lost objects warnings", wl);
