 ...
 * @version 2007
 */
public class SaveCallback implements AsyncCallback {
    ...
    public void onFailure(Throwable caught) {
        IndexModule.getKikooBox().showError("Server error, request not saved",
                2000);
    }
    ...
    public void onSuccess(Object result) {
        IndexModule.getKikooBox().showOk("Request saved", 1000);
    }
}
