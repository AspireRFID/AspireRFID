...
/**
 * List users widget callback.
 * 
 * @author Guillaume Vaudaux-Ruth
 * @version 2007
 */
public class ListUsersCallbackGetList implements AsyncCallback {
     ...
     * @param listUsers
     */
    public ListUsersCallbackGetList(ListUsers listUsers) {
