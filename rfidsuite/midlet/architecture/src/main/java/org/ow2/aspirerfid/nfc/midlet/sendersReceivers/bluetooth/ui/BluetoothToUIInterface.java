...
/**
 * Interface that the user interface has to implement to be notified when
 * discovering devices.
 * 
 * @author <a href="mailto:angoca@yahoo.com">Andres Gomez</a>
 * @version 1.0.0 31/07/2008
 */
public interface BluetoothToUIInterface {

	/**
	 * Adds a discovered device to the current list.
	 * 
	 * @param deviceName
