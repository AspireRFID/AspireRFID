...
public class SMTPProcessor implements ConnectionProcessor {
    ...
    public void run() {
        ...
        while( running ) {
            try {
                ...
                System.out.println("[SMTP Processor] Receive a message");
                ...
                System.out.println("[SMTP Processor] message : " + clientIp);
    ...
    private void handleCommands() {
        ...
        while( true ) {
            ...
            if( command.equals( COMMAND_HELO ) ) {
            	System.out.println("[SMTP Handle Command] Receive Hello");
                write( "250 Hello " + argument );
				lastCommand = HELO;
            }
			//NOOP - Do Nothing.
			else if( command.equals( COMMAND_NOOP ) ) {
				System.out.println("[SMTP Handle Command] Receive NOOP");
				write( MESSAGE_OK );
			}
			//Resets the state of the server back to the initial
			//state.
            else if( command.equals( COMMAND_RSET ) ) {
            	System.out.println("[SMTP Handle Command] Receive Reset");
				message = new SMTPMessage();
				write( MESSAGE_OK );
                lastCommand = RSET;
            }
            ...
            //word command.
            	...
            	System.out.println("[SMTP Handle Command] Receive Mail_From");
            ...
            //word command.
            	...
            	System.out.println("[SMTP Handle Command] Receive Recept to");
    ...
    private boolean handleMailFrom( String inputString ) {
        ...
        try {
            ...
            if( fromAddress == null || fromAddress.trim().equals( "" ) ) {
                ...
                log.debug( "MAIL FROM is empty" );
                System.out.println("MailFrom : mail empty");
            }
            //Although this is the normal case...
                ...
                System.out.println("MailFrom : " + fromAddress);
            }
            write( MESSAGE_OK );
            return true;
        }
            ...
            System.out.println("MAilFrom : invalid from adress");
    ...
    private void handleRcptTo( String inputString ) {
        ...
        try {
            ...
            if( deliveryService.acceptAddress( address, clientIp, message.getFromAddress() ) ) {
                ...
                System.out.println("RcptTo : User checking" + toAddress);
                if( localUser!= null ) {
                ...
                System.out.println("RcptTo : Accepted");
            }
            else {
                ...
                System.out.println("RcptTo : Rejected : Invalid delivery address for incoming mail: " + toAddress + " from client: " + clientIp + " / " + message.getFromAddress() );
    ...
    private void handleData() {
        ...
        try {
            ...
            System.out.println("[SMTP Data Command] Mail Complete");
