...
/**
 * This exception is thrown by the ALE API methods which take an ECSpec argument
...
public class ECSpecValidationException extends Exception {
	...
	private static final long serialVersionUID = -7119052168542940732L;
	...
	public ECSpecValidationException(String message) {
		super("The specified ECSpec is invalid : " + message);
	}
